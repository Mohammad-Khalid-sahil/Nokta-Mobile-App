...
strict_1.default.equal((0, timetableValidationService_1.subjectBelongsToClass)({ _id: 'subject-d' }, { _id: 'class-a', subjectId: 'subject-d', assignedSubjects: [] }), true, 'class.subjectId should link subject to class');
...
strict_1.default.equal((0, timetableValidationService_1.teacherCanTeachClassSubject)({ _id: 'teacher-c', assignedClasses: [], assignedSubjects: [] }, { _id: 'class-a', teacherId: 'teacher-c', assignedSubjects: ['subject-a'], assignedTeachers: [] }, subject), true, 'class primary teacher should be allowed');
