...
const bookSchema = joi_1.default.object({
    body: joi_1.default.object({
        ...
        description: joi_1.default.string().trim().allow('').default(''),
...
router.post('/', (0, auth_1.authorize)(['super_admin', 'admin', 'branch_manager', 'librarian']), (0, validate_1.validate)(bookSchema), async (req, res, next) => {
    try {
...
router.put('/:id', (0, auth_1.authorize)(['super_admin', 'admin', 'branch_manager', 'librarian']), (0, validate_1.validate)(idSchema), (0, validate_1.validate)(updateBookSchema), async (req, res, next) => {
    try {
