...
router.post('/', (0, auth_1.authorize)(['super_admin', 'admin', 'branch_manager']), (0, validate_1.validate)(paymentSchema), async (req, res, next) => {
    try {
        ...
        const student = isStudentPayment
            ? await Student_1.Student.findOne({ _id: req.body.studentId, isDeleted: false, status: 'active' }).lean()
            : null;
