...
exports.AIResultInsight = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const schema_1 = require("../utils/schema");
const aiResultInsightSchema = (0, schema_1.createBaseSchema)({
    ...
    resultId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Result', default: null, index: true },
...
exports.AIResultInsight = mongoose_1.default.models.AIResultInsight ?? mongoose_1.default.model('AIResultInsight', aiResultInsightSchema);
